...
const handleStart = () => {
    ...
    countTime = setInterval(() => {
        if (seconds < 9) {
            ...
            if(minutes <= 9){
                stopwatch.textContent = `${hours}:0${minutes}:0${seconds}`
            }
            else if((minutes > 9 && minutes <= 59)){
                stopwatch.textContent = `${hours}:${minutes}:0${seconds}`
            }

            else{
             hours++;
             minutes = 0;
             stopwatch.textContent = `${hours}:00:0${seconds}`
            ...
            if(minutes <= 9){
                stopwatch.textContent = `${hours}:0${minutes}:${seconds}`
            }
            else if((minutes > 9 && minutes <= 59)){
                ...
                hours++;
                minutes = 0;
                stopwatch.textContent = `${hours}:00:${seconds}`
            ...
            if(minutes <= 9){
                stopwatch.textContent = `${hours}:0${minutes}:00`
            }
            else if((minutes > 9 && minutes <= 59)){
                stopwatch.textContent = `${hours}:${minutes}:00`
            }
